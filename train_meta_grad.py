...
def main():
    ...
    parser.add_argument('--notaddrussian', default=False, type = bool, help = "Skip russian as a task")
    ...
    elif args.notaddrussian:
        train_languages = train_languages[russian_indices]
        train_languages_lowercase = train_languages_lowercase[russian_indices]
